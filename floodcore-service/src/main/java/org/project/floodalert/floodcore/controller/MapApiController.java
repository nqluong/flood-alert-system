...
public class MapApiController {
         ...
         * <p>
         * Ví dụ:
         * {@code GET /api/v1/core/floods/active/nearby?lat=10.776&lon=106.700&radius=5}
         *
         ...
         * <p>
         * Ví dụ:
         * {@code GET /api/v1/core/routes/safe-path?startLat=10.776&startLon=106.700&endLat=10.780&endLon=106.710&vehicleType=MOTORBIKE}
         *
