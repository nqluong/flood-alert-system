...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleValidationException(
        ...
        ErrorResponse errorResponse = ErrorResponse.builder()
                .success(false)
                .code(CoreErrorCode.VALIDATION_ERROR.getCode())
                .message(CoreErrorCode.VALIDATION_ERROR.getMessage())
        ...
        return ResponseEntity
                .status(CoreErrorCode.VALIDATION_ERROR.getHttpStatus())
                .body(errorResponse);
    }
    ...
    public ResponseEntity<ErrorResponse> handleGeneralException(
        ...
        ErrorResponse errorResponse = ErrorResponse.builder()
                .success(false)
                .code(CoreErrorCode.INTERNAL_SERVER_ERROR.getCode())
                .message(ex.getMessage())
                .details(CoreErrorCode.INTERNAL_SERVER_ERROR.getMessage())
                .path(request.getRequestURI())
                .build();

        return ResponseEntity
                .status(CoreErrorCode.INTERNAL_SERVER_ERROR.getHttpStatus())
                .body(errorResponse);
    }
}
